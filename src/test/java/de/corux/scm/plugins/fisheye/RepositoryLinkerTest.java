...
public class RepositoryLinkerTest
{
    ...
    public void testUpdateRepositoriesMultipleFisheyeReposMappedToOneScmRepo() throws IOException
    {
        ...
        // act
        runTestUpdateRepositories(repo1, repo2);
    }
    ...
    public void testUpdateRepositoriesForGit() throws IOException
    {
        ...
        // act
        runTestUpdateRepositories(repo);
    }
    ...
    private void runTestUpdateRepositories(de.corux.scm.plugins.fisheye.client.Repository... fisheyeRepos)
            throws IOException
    {
        // arrange
