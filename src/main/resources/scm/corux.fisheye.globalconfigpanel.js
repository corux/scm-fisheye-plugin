    ...
    .extend(
        Ext.Window,
        {
          ...
          initComponent : function() {
            ...
            Sonia.action.ChangePasswordWindow.superclass.initComponent.apply(
                this, arguments);
          },
    ...
    .extend(
        Sonia.config.ConfigForm,
        {
          ...
          initComponent : function() {
            ...
            Ext.apply(this, Ext.apply(this.initialConfig, config));
            corux.fisheye.GlobalConfigPanel.superclass.initComponent.apply(
                this, arguments);
          },
